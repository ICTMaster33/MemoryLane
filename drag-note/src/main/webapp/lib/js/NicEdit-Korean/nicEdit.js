 ...
 */
var ICON_PATH = "/00_drag-note/lib/js/NicEdit-Korean/nicEditorIcons.png";
var FONT_FAMILY = {
	"Gulim,굴림"			: "굴림",
	"궁서"					: "궁서",
...
var bkLib = {
	...
	onDomLoaded : function(fireThis) {
		...
		if (document.addEventListener) {
			...
			document.write("id='myEditor' <style>.nicEdit-main p { margin: 0; }</style><scr"+"ipt id=__ie_onload defer " + ((location.protocol == "https:") ? "src='javascript:void(0)'" : "src=//0") + "><\/scr"+"ipt>");
...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : ICON_PATH,
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','upload','forecolor'],
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '1024', border : '1px solid #cccccc', backgroundColor : '#efefef'}).addClass('panelContain');
